...
public class WindowCode extends BaseCode {
     ...
     * @return
     */
    public static String dialog_click_text(String procedureName,String text) {
        String format=TABS_LINE+"//%s"+END_LINE
                +TABS_LINE+"TWindow.dialog_click_text(\"%s\")"+END_LINE;
        return String.format(format,procedureName,text);
    }
     ...
     * @return
     */
    public static String dialog_click_contains_text(String procedureName,String text) {
        String format=TABS_LINE+"//%s"+END_LINE
                +TABS_LINE+"TWindow.dialog_click_contains_text(\"%s\")"+END_LINE;
        return String.format(format,procedureName,text);
    }
    /**
     * 点击Popwindow中的控件
