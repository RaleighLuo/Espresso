...
public interface TableConfig {//表头
    ...
    String INTENT_EXTRA="IntentExtra";//Intent值(;split)
    String PREMISSIONS="Premissions";//所需权限 ;分隔
    ...
    //module头部名称
    String[] MODULE_HEADERS={MODULE_NUMBER,MODULE_NAME,IS_CREATE,CLASS_NAME,CLASS_PACKAGE_NAME,INTENT_EXTRA,PREMISSIONS};
    //测试用例头部名称
